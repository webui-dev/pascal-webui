...
begin
  ...
  webui_show(window, '<!DOCTYPE html><html><head><script src="/webui.js"></script></head><body><style>#main {width: 500; height: 500;}</style><h1 style="color: green;">Hello world!</h1><h3><br/><br/><button id="MyID">Hello</button></h3></body></html>');
  webui_wait;
end.
