...
begin
  ...
  webui_show(window, '<html><style>#main {width: 500; height: 500;}</style><h1 style="color: green;">this lesson to lear button event and links with pascal</h1><h3><br/><br/><button id="MyID">Hello</button></h3>');
  webui_wait;
end.
